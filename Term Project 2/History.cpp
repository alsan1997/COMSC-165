  ...
  while(true)
  {
    ...
    else if(buf[0] == 'b' || buf[0] == 'B')
    {
      ...
      while(true)
      {
        ...
        if(t == 0)
        {
          cout << "Sorry, but your list is empty !" << endl << endl;
          break;
        }

        // Cout table and courses
        table(start);
        printlist(t);

        // Ask user whether to delete, Keep, or quit
        cout << endl;
        cout << "Starting from the first row..." << endl;
        cout << "Do you want to Keep the course , Delete the course, or Quit ? Enter (K,D,Q): ";
        cin >> buf;
        choice2 = atoi(buf);
        cout << endl;
        ...
        // Break if users enter q
        if(buf[0] == 'q' || buf[0] == 'Q')break;

        // Keep and set pointer to next node
        if(buf[0] == 'k' || buf[0] == 'K')
        {
          if(t->next)
          {
          ...
          {
            cout << "Alright ! That is the end of the list !" << endl << endl;
            break;
          }
        }
      }
    ...
    {
      // While loop to ask which kind of sorting users want
      while(true)
      {
